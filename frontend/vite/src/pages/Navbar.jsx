  ...
  return (
    <header
      className={`fixed w-full z-20 transition-all duration-300 ${
        scrolled ? "hidden" : "bg-none shadow-md py-2"
      }`}
    >
        ...
        <nav className="hidden md:flex gap-10 items-center">
            ...
            <NavLink to="/" end>
              {({ isActive }) => (
                <li className="relative group flex flex-col items-center cursor-pointer">
                  ...
                  <span className="absolute top-full mt-2 opacity-0 group-hover:opacity-100 text-xs transition">
                    Home
                  </span>
                </li>
              )}
          ...
          <NavLink to="/cart" className="relative">
            {({ isActive }) => (
              <>
                ...
                <span className="absolute -top-2 -right-4 px-2 text-xs">
                  {cart?.items?.length || 0}
                </span>
              </>
            )}
          ...
          {user ? (
            <LogOut
              ...
              className="hover:scale-125 cursor-pointer hover:text-red-500 "
            />
          ) : (
            <LogIn
              onClick={() => navigate("/login")}
              className="hover:scale-125 cursor-pointer hover:text-pink-500"
            />
          )}
        </nav>
