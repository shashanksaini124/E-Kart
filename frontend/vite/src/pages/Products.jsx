...
//   return (
//     <div className="pt-20 pb-10 bg-gradient-to-b from- via-gray-100 to-yellow-100">
//       {/* 🔎 Search */}
//       <div className="relative w-2/3 ml-20   mt-10 sm:max-w-md bg-white rounded-lg">
//         <Input
//           type="text"
//           value={search}
    ...
    <div className="pt-20 pb-10 bg-gradient-to-b via-gray-100 to-yellow-100">
      ...
      <div className="max-w-7xl mx-auto flex gap-7">
        ...
        <div className="flex flex-col p-1 flex-1">
          ...
          {/* PRODUCTS GRID */}
          <div className="fade-up grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-7">
